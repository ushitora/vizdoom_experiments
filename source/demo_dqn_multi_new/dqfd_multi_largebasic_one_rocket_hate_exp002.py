...
#         parameter_server.load_model(sess=sess, step=15, model_path="models/model_temp/model_2019-01-16-15-32-54/model.ckpt")
    parameter_server.load_model(sess=sess, step=15, model_path="../data/demo_dqn/models/model_2019-01-30-09-55-13/model.ckpt")
...
parameter_server.load_model(sess=sess, step=15, model_path="../data/demo_dqn/models/model_2019-01-30-12-33-05/model.ckpt")
test_env.network.pull_parameter_server(sess)
test_env.network.copy_network_learning2target(sess)
